    ...
    async def wrapper(self, name: str, arguments: dict | None):
        if not self._sessions:
            return [
                types.TextContent(
                    type="text",
                    text="No active session. Please create a new session first.",
                )
            ]
...
class ScreenshotToolHandler(ToolHandler):
    async def handle(
        ...
        return [
            types.ImageContent(type="image", data=encoded_string, mimeType="image/png")
        ]
...
class ClickToolHandler(ToolHandler):
    ...
    async def handle(
        ...
        return [
            types.TextContent(
                type="text", text=f"Clicked element with selector {selector}"
            )
        ]
...
class FillToolHandler(ToolHandler):
    async def handle(
        ...
        return [
            types.TextContent(
                type="text",
                text=f"Filled element with selector {selector} with value {value}",
            )
        ]
...
class EvaluateToolHandler(ToolHandler):
    async def handle(
        ...
        return [
            types.TextContent(type="text", text=f"Evaluated script, result: {result}")
        ]
...
class ClickTextToolHandler(ToolHandler):
    ...
    async def handle(
        ...
        return [
            types.TextContent(type="text", text=f"Clicked element with text {text}")
        ]
...
class GetHtmlContentToolHandler(ToolHandler):
    async def handle(
        ...
        return [
            types.TextContent(
                type="text",
                text=f"HTML content of element with selector {selector}: {html_content}",
            )
        ]
